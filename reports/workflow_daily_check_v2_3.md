# Workflow Run: Daily Project Check
...
| `doctor` | `run_doctor` | planned | Would run workspace health with 5 finding(s). | `reports/workflow_daily_check_workspace_health.md` |
| `rules` | `run_rules` | planned_with_errors | Would run rules with 16 finding(s). | `reports/workflow_daily_check_rules.md` |
| `dashboard` | `run_dashboard` | planned | Would generate dashboard report. | `reports/workflow_daily_check_dashboard.md` |
...
- `reports/workflow_daily_check_workspace_health.md`
- `reports/workflow_daily_check_rules.md`
- `reports/workflow_daily_check_dashboard.md`
