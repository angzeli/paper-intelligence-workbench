...
- Added focused tests for scanning, hashing, duplicates, missing files, file registry save/load, file linking, file unlinking, sidecar discovery, CLI smoke paths, and tracked-PDF policy.
