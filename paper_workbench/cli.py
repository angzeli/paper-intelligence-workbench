...
def build_parser() -> argparse.ArgumentParser:
    ...
    support_bundle_mode = support_bundle.add_mutually_exclusive_group()
    support_bundle_mode.add_argument("--safe", action="store_true", help="Use safe redaction mode. This is the default.")
    support_bundle_mode.add_argument("--verbose-local-only", action="store_true", help="Include more local metadata for private debugging; inspect before sharing.")
