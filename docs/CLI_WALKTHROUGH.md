...
This walkthrough uses synthetic data only and avoids writing over repository reports by sending generated files to `/private/tmp`.
...
```bash
paperwb claims data/notes --output /private/tmp/paperwb_walkthrough_claims.csv
```
...
```bash
paperwb report evidence-map --registry data/registries/example_papers.csv --bibtex data/bibtex/example_library.bib --notes-dir data/notes --themes data/examples/themes.json --out /private/tmp/paperwb_walkthrough_evidence_map.md --force
paperwb report citation-audit --registry data/registries/example_papers.csv --bibtex data/bibtex/example_library.bib --notes-dir data/notes --themes data/examples/themes.json --out /private/tmp/paperwb_walkthrough_citation_audit.md --force
paperwb report section-outline --theme photocorrosion --registry data/registries/example_papers.csv --bibtex data/bibtex/example_library.bib --notes-dir data/notes --themes data/examples/themes.json --out /private/tmp/paperwb_walkthrough_section_outline.md --force
```
...
paperwb report evidence-map --project zis_photocatalysis --out /private/tmp/paperwb_walkthrough_zis_evidence_map.md --force
```
...
```bash
paperwb export claims-json --project zis_photocatalysis --out /private/tmp/paperwb_walkthrough_zis_claims.json --force
paperwb export theme-claims --project zis_photocatalysis --theme photocorrosion --out /private/tmp/paperwb_walkthrough_photocorrosion_claims.json --force
```
...
```bash
paperwb doctor --registry data/registries/example_papers.csv --bibtex data/bibtex/example_library.bib --notes-dir data/notes --themes data/examples/themes.json --out /private/tmp/paperwb_walkthrough_workspace_health.md --force
```
