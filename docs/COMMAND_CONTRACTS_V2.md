...
| `rebuild` | Incremental rebuild planning | project/local files | plan/status report, `.paperwb/rebuild_metadata.json`, local audit-log event | metadata/audit cache only; no report/index regeneration | experimental | rebuild tests |
