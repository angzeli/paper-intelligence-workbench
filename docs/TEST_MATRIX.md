...
| Documentation checks | Markdown docs links, path hygiene, and `paperwb` command examples are checked | `tests/test_docs_v3_4.py`, `scripts/check_docs.py` | `docs/index.md`, `docs/cookbook/index.md` | Does not execute every command example |
