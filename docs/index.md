...
Paper Intelligence Workbench is a local-first CLI for literature-review evidence tracking. It manages registry rows, BibTeX keys, structured notes, user-written claims, evidence reports, draft QA, reading workflows, backups, compatibility checks, and sanitized diagnostics.

It does not read papers for you, scrape publishers, use cloud or LLM APIs, fabricate claims, judge scientific truth, or write final prose.

## Start Here

1. [Getting Started](getting-started/index.md)
2. [Full Literature Review Walkthrough](workflows/full-literature-review-walkthrough.md)
3. [Cookbook](cookbook/index.md)
4. [Stable Surface v3](STABLE_SURFACE_V3.md)
5. [CLI Reference v3](CLI_REFERENCE_V3.md)
6. [Known Limitations v3](KNOWN_LIMITATIONS_V3.md)
...
- [Report Gallery](reports/index.md)

## Private Dogfooding

- [Dogfooding Guide v3](DOGFOODING_GUIDE_V3.md)
- [Dogfooding Workflow](DOGFOODING_WORKFLOW.md)
- [Private Dogfooding](PRIVATE_DOGFOODING.md)
- [External Workspaces](EXTERNAL_WORKSPACES.md)
- [Local-only Config](LOCAL_ONLY_CONFIG.md)
- [Real Project Safety](REAL_PROJECT_SAFETY.md)
...
These workflows are useful but not API-frozen. Prefer dry-run modes and project-local outputs.
...
- [Backup Bundles](BACKUP_BUNDLES.md)
- [Generated Report Policy](GENERATED_REPORT_POLICY.md)
- [Writing Boundaries](WRITING_BOUNDARIES.md)
