# Paper Note: Synthetic ZIS photocatalysis Study 002: Photocorrosion under Local Review Conditions

## Metadata
- Paper ID: stress_zis_photocatalysis_synthetic_002
- BibTeX key: stress_zis_photocatalysisSynthetic2018002
...
### Claim 2
- Claim: Synthetic claim 2 for stress_zis_photocatalysis_synthetic_002 records user-tracked evidence about photocorrosion.
...
### Claim 42
- Claim: Synthetic claim 42 for stress_zis_photocatalysis_synthetic_002 records user-tracked evidence about photocorrosion.
- Evidence type: experimental_result
- Section / page: Section 1 p. 44
- Quote or paraphrase: Synthetic paraphrase only; no real paper quote is represented.
- Confidence: low
- Tags: photocorrosion; zis-stress
- User comment: Generated for local stress testing; verify real claims manually.
...
### Claim 82
- Claim: Synthetic claim 82 for stress_zis_photocatalysis_synthetic_002 records user-tracked evidence about photocorrosion.
- Evidence type: background_context
- Section / page: Section 5 p. 84
- Quote or paraphrase: Synthetic paraphrase only; no real paper quote is represented.
- Confidence: low
- Tags: photocorrosion; zis-stress
- User comment: Generated for local stress testing; verify real claims manually.
