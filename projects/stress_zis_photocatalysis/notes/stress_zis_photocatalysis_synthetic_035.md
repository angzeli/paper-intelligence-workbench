# Paper Note: Synthetic ZIS photocatalysis Study 035: Band Alignment under Local Review Conditions

## Metadata
- Paper ID: stress_zis_photocatalysis_synthetic_035
- BibTeX key: stress_zis_photocatalysisSynthetic2024035
...
### Claim 31
- Claim: Synthetic claim 31 for stress_zis_photocatalysis_synthetic_035 records user-tracked evidence about thin-film fabrication.
...
### Claim 71
- Claim: Synthetic claim 71 for stress_zis_photocatalysis_synthetic_035 records user-tracked evidence about thin-film fabrication.
- Evidence type: opinion_or_interpretation
- Section / page: Section 6 p. 73
- Quote or paraphrase: Synthetic paraphrase only; no real paper quote is represented.
- Confidence:
- Tags: thin-film-fabrication; zis-stress
- User comment: Generated for local stress testing; verify real claims manually.
