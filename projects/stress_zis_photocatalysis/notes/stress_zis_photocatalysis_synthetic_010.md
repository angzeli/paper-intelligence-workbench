# Paper Note: Synthetic ZIS photocatalysis Study 010: Band Alignment under Local Review Conditions

## Metadata
- Paper ID: stress_zis_photocatalysis_synthetic_010
- BibTeX key: stress_zis_photocatalysisSynthetic2017010
- DOI: 10.9300/synthetic.stress_zis_photocatalysis.010
- Year: 2017
- Journal: Synthetic Zis Photocatalysis Reports
- Tags: band-alignment; zis-stress
...
### Claim 9
- Claim: Synthetic claim 9 for stress_zis_photocatalysis_synthetic_010 records user-tracked evidence about charge separation.
...
### Claim 49
- Claim: Synthetic claim 49 for stress_zis_photocatalysis_synthetic_010 records user-tracked evidence about charge separation.
- Evidence type: review_statement
- Section / page: Section 2 p. 51
- Quote or paraphrase: Synthetic paraphrase only; no real paper quote is represented.
- Confidence: medium
- Tags: charge-separation; zis-stress
- User comment: Generated for local stress testing; verify real claims manually.
...
### Claim 89
- Claim: Synthetic claim 89 for stress_zis_photocatalysis_synthetic_010 records user-tracked evidence about charge separation.
- Evidence type: review_statement
- Section / page: Section 6 p. 91
- Quote or paraphrase: Synthetic paraphrase only; no real paper quote is represented.
- Confidence: medium
- Tags: charge-separation; zis-stress
- User comment: Generated for local stress testing; verify real claims manually.
