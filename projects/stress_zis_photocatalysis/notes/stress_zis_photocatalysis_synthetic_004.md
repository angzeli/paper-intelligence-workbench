# Paper Note: Synthetic ZIS photocatalysis Study 004: Catalyst Stability under Local Review Conditions

## Metadata
- Paper ID: stress_zis_photocatalysis_synthetic_004
- BibTeX key: stress_zis_photocatalysisSynthetic2017001
...
### Claim 4
- Claim: Synthetic claim 4 for stress_zis_photocatalysis_synthetic_004 records user-tracked evidence about catalyst stability.
- Evidence type: background_context
- Section / page: Section 5 p. 6
...
### Claim 44
- Claim: Synthetic claim 44 for stress_zis_photocatalysis_synthetic_004 records user-tracked evidence about catalyst stability.
- Evidence type: theory_or_mechanism
- Section / page: Section 3 p. 46
- Quote or paraphrase: Synthetic paraphrase only; no real paper quote is represented.
- Confidence: high
- Tags: catalyst-stability; zis-stress
- User comment: Generated for local stress testing; verify real claims manually.
...
### Claim 84
- Claim: Synthetic claim 84 for stress_zis_photocatalysis_synthetic_004 records user-tracked evidence about catalyst stability.
- Evidence type: experimental_result
- Section / page: Section 1 p. 86
- Quote or paraphrase: Synthetic paraphrase only; no real paper quote is represented.
- Confidence: high
- Tags: catalyst-stability; zis-stress
- User comment: Generated for local stress testing; verify real claims manually.
