# Paper Note: Synthetic ZIS photocatalysis Study 019: Catalyst Stability under Local Review Conditions

## Metadata
- Paper ID: stress_zis_photocatalysis_synthetic_019
- BibTeX key: stress_zis_photocatalysisSynthetic2017019
...
### Claim 17
- Claim: Synthetic claim 17 for stress_zis_photocatalysis_synthetic_019 records user-tracked evidence about charge separation.
- Evidence type: review_statement
- Section / page: Section 6 p. 19
- Quote or paraphrase: Synthetic paraphrase only; no real paper quote is represented.
- Confidence: medium
- Tags: charge-separation; zis-stress
- User comment: Generated for local stress testing; verify real claims manually.
- Strength: moderate
- Supports theme: charge separation

### Claim 57
- Claim: Synthetic claim 57 for stress_zis_photocatalysis_synthetic_019 records user-tracked evidence about charge separation.
- Evidence type: review_statement
- Section / page: Section 4 p. 59
- Quote or paraphrase: Synthetic paraphrase only; no real paper quote is represented.
- Confidence: medium
- Tags: charge-separation; zis-stress
- User comment: Generated for local stress testing; verify real claims manually.
...
### Claim 97
- Claim: Synthetic claim 97 for stress_zis_photocatalysis_synthetic_019 records user-tracked evidence about charge separation.
- Evidence type: review_statement
- Section / page: Section 2 p. 99
- Quote or paraphrase: Synthetic paraphrase only; no real paper quote is represented.
- Confidence: medium
- Tags: charge-separation; zis-stress
- User comment: Generated for local stress testing; verify real claims manually.
