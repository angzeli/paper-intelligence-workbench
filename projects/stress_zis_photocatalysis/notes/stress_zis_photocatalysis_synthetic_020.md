# Paper Note: Synthetic ZIS photocatalysis Study 020: Band Alignment under Local Review Conditions

## Metadata
- Paper ID: stress_zis_photocatalysis_synthetic_020
- BibTeX key: stress_zis_photocatalysisSynthetic2018020
...
### Claim 18
- Claim: Synthetic claim 18 for stress_zis_photocatalysis_synthetic_020 records user-tracked evidence about photocorrosion.
- Evidence type: experimental_result
- Section / page:
- Quote or paraphrase: Synthetic paraphrase only; no real paper quote is represented.
- Confidence: low
- Tags: photocorrosion; zis-stress
- User comment: Generated for local stress testing; verify real claims manually.
- Strength: weak
- Supports theme: photocorrosion

### Claim 58
- Claim: Synthetic claim 58 for stress_zis_photocatalysis_synthetic_020 records user-tracked evidence about photocorrosion.
...
### Claim 98
- Claim: Synthetic claim 98 for stress_zis_photocatalysis_synthetic_020 records user-tracked evidence about photocorrosion.
- Evidence type: theory_or_mechanism
- Section / page: Section 3 p. 100
- Quote or paraphrase: Synthetic paraphrase only; no real paper quote is represented.
- Confidence: low
- Tags: photocorrosion; zis-stress
- User comment: Generated for local stress testing; verify real claims manually.
