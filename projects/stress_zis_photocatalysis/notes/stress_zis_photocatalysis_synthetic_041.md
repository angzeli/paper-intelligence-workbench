# Paper Note: Synthetic ZIS photocatalysis Study 041: Charge Separation under Local Review Conditions

## Metadata
- Paper ID: stress_zis_photocatalysis_synthetic_041
- BibTeX key: stress_zis_photocatalysisSynthetic2021041
...
### Claim 36
- Claim: Synthetic claim 36 for stress_zis_photocatalysis_synthetic_041 records user-tracked evidence about catalyst stability.
...
### Claim 76
- Claim: Synthetic claim 76 for stress_zis_photocatalysis_synthetic_041 records user-tracked evidence about catalyst stability.
- Evidence type: background_context
- Section / page: Section 5 p. 78
- Quote or paraphrase: Synthetic paraphrase only; no real paper quote is represented.
- Confidence: high
- Tags: catalyst-stability; zis-stress
- User comment: Generated for local stress testing; verify real claims manually.
