# Paper Note: Synthetic ML methods Study 014: Dataset Shift under Local Review Conditions

## Metadata
- Paper ID: stress_ml_methods_synthetic_014
- BibTeX key: stress_ml_methodsSynthetic2021014
...
### Claim 13
- Claim: Synthetic claim 13 for stress_ml_methods_synthetic_014 records user-tracked evidence about ML methodology.
- Evidence type: review_statement
- Section / page: Section 2 p. 15
- Quote or paraphrase: Synthetic paraphrase only; no real paper quote is represented.
- Confidence: medium
- Tags: ml-methodology; ml-stress
- User comment: Generated for local stress testing; verify real claims manually.
- Strength: moderate
- Supports theme: ML methodology

### Claim 40
- Claim: Synthetic claim 40 for stress_ml_methods_synthetic_014 records user-tracked evidence about dataset shift.
- Evidence type: background_context
- Section / page: Section 5 p. 42
- Quote or paraphrase: Synthetic paraphrase only; no real paper quote is represented.
- Confidence: high
- Tags: dataset-shift; ml-stress; cross-theme
- User comment: Generated for local stress testing; verify real claims manually.
- Strength: strong
