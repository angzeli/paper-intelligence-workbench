# Paper Note: Synthetic ML methods Study 004: Dataset Shift under Local Review Conditions

## Metadata
- Paper ID: stress_ml_methods_synthetic_004
- BibTeX key: stress_ml_methodsSynthetic2017001
- DOI: 10.9300/synthetic.stress_ml_methods.004
- Year: 2020
- Journal: Synthetic Ml Methods Reports
- Tags: dataset-shift; ml-stress
...
### Claim 4
- Claim: Synthetic claim 4 for stress_ml_methods_synthetic_004 records user-tracked evidence about dataset shift.
...
- Strength: strong
- Supports theme: dataset shift

### Claim 31
- Claim: Synthetic claim 31 for stress_ml_methods_synthetic_004 records user-tracked evidence about benchmark leakage.
- Evidence type: method_description
- Section / page: Section 2 p. 33
- Quote or paraphrase: Synthetic paraphrase only; no real paper quote is represented.
- Confidence:
- Tags: benchmark-leakage; ml-stress
- User comment: Generated for local stress testing; verify real claims manually.
- Strength: speculative
- Supports theme: benchmark leakage

### Claim 58
- Claim: Synthetic claim 58 for stress_ml_methods_synthetic_004 records user-tracked evidence about robustness.
- Evidence type: background_context
- Section / page: Section 5 p. 60
- Quote or paraphrase: Synthetic paraphrase only; no real paper quote is represented.
- Confidence: low
- Tags: robustness; ml-stress
- User comment: Generated for local stress testing; verify real claims manually.
- Strength: weak
- Supports theme: robustness
